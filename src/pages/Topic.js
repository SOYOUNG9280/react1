...
function Topic() {
  ...
  return (
    <div style={{ display: 'flex', height: '100vh' }}>
      {/* Left Section */}
      <div style={{ flex: 1, backgroundColor: '#f5f5f5', padding: '20px', display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
      ...
      {/* Right Section */}
      <div style={{ flex: 1, backgroundColor: '#e0e0e0', padding: '20px', display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
